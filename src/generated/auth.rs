...
pub mod auth_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut().insert(GrpcMethod::new("auth.AuthService", "GetToken"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("auth.AuthService", "IntrospectToken"));
            self.inner.unary(req, path, codec).await
        }
    }
}
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/auth.AuthService/GetToken" => {
                    ...
                    struct GetTokenSvc<T: AuthService>(pub Arc<T>);
                    impl<
                        T: AuthService,
                    ...
                    for GetTokenSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AuthService>::get_token(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/auth.AuthService/IntrospectToken" => {
                    #[allow(non_camel_case_types)]
                    struct IntrospectTokenSvc<T: AuthService>(pub Arc<T>);
                    impl<
                        T: AuthService,
                    ...
                    for IntrospectTokenSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AuthService>::introspect_token(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
